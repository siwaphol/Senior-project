<?php
	...
	class sso_facebook extends SSO_ProviderBase
	{
		...
		private static $fieldmap = array(
			...
			"languages" => array("title" => "Languages", "desc" => "user's languages", "extra" => "user_likes"),
			"link" => array("title" => "Profile URL", "desc" => "user's profile URL", "extra" => ""),
			"username" => array("title" => "Username", "desc" => "username", "extra" => "", "notes" => "Depending on the account, this may be empty."),
			...
			"updated_time" => array("title" => "Last Updated", "desc" => "user's last profile update time", "extra" => ""),
			...
			"interested_in" => array("title" => "Interested In (Gender)", "desc" => "user's gender interest", "extra" => "user_relationship_details"),
			...
			"video_upload_limit_length" => array("title" => "Video Upload Limit - Length", "desc" => "user's maximum video upload length", "extra" => "", "parent" => "video_upload_limits"),
			"video_upload_limit_size" => array("title" => "Video Upload Limit - Size", "desc" => "user's maximum video upload size", "extra" => "", "parent" => "video_upload_limits"),
		...
		public function ProcessFrontend()
		{
			...
			if ($id)
			{
				try
				{
					...
					foreach (self::$fieldmap as $key => $info)
					{
						if ($sso_settings["sso_facebook"]["map_" . $key] != "")  $fields[(isset($info["parent"]) ? $info["parent"] : $key)] = true;
					}
			...
			if (isset($_REQUEST["sso_facebook_action"]) && $_REQUEST["sso_facebook_action"] == "signin")
			{
				...
				{
					$message = BB_Translate("An unknown error occurred.");
				}
