<?php
	...
	class sso_login_module_sso_antiphish extends sso_login_ModuleBase
	{
		...
		{
			$options["sso_antiphish"] = "Anti-phishing phrase";
		}

		public function AddFindUserCols(&$cols)
		{
			if (!isset($_REQUEST["extra_output"]["sso_antiphish"]))  return false;

			$cols[] = "Anti-Phishing Phrase";
		...
		{
			$result[] = (isset($userinfo["sso_antiphish"]) ? htmlspecialchars($userinfo["sso_antiphish"]) : BB_Translate("<i>Missing</i>"));
		}
