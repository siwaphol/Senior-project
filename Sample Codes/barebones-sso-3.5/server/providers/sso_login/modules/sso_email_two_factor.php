<?php
	...
	class sso_login_module_sso_email_two_factor extends sso_login_ModuleBase
	{
		...
		public function SendTwoFactorCode(&$result, $userrow, $userinfo)
		{
			...
			if (!$result["success"])  $messages["errors"][] = BB_Translate("Login exists but a fatal error occurred.  Fatal error:  Unable to send two-factor authentication e-mail.  %s", $result["error"]);
		}
	}
?>