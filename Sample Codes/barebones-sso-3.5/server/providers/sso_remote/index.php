...
<?php
		...
		{
			global $sso_provider, $sso_target_url, $sso_session_info, $sso_session_id, $sso_db;
			...
			if (isset($sso_session_info["setlogin_result"]) && !isset($_REQUEST["tryagain"]))
			{
				...
				try
				{
					...
					SSO_ActivateUser($id, serialize($sso_session_info["setlogin_info"]), $mapinfo, $this->info["row_info"]["automate"]);
