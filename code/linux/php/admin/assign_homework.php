...
if( isset($_POST['Submit']) ){
	...
	$sql = "INSERT INTO homework_assignment (courseId,homeworkId,homeworkFileName,homeworkFileType,homeworkDetail,subFolder,dueDate,assignDate,assignmenttype) VALUES ('$course', '$hwId', '$filename', '$filetype', '$detail', '$lab', '$duedate', '$asdate','$assigntype') ";
            ...
            <tbody>
                 <tr>
				  ...
				  <!--<tr>
					...
					ชื่อไฟล์ &nbsp;</td>
					<td><br />
					  <input type="text" value="<?php/*=$_POST['fname']  */?>" name="fname" id="fname" /><font color="#FF0000">*</font>
				    <br /><font color="#000099">ชื่อไฟล์ตามด้วยรหัสนักศึกษา เช่น it1 <br /> นักศึกษาส่งไฟล์ชื่อ it1_500510XXX</font></td>
				  </tr> 
				  -->
				  <tr>
