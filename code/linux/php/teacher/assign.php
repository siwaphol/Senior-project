                ...
                <tr>
                  ...
                  <td width="221" bgcolor="#E0F1FC"><label>
					...
					<select id="ddlCourse" name="ddlCourse" >
						...
						<?php
						$teach = $_SESSION['user'];
						$strSQL = "SELECT courseId FROM course_section WHERE teacherId ='$teach' ORDER BY courseId ASC ";
...
<form name="form1" method="post" onsubmit="return onSubmitForm1()">
  <table width="700" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#425969">
                ...
                <tr>
                  <td colspan="9" bgcolor="#BDE3F9">&nbsp;<a href="index_teacher.php?assign&add&course=<?php echo $course?>">กำหนดการบ้าน</a></td>
				</tr>
				 <tr>
                ...
                <tr>
                  ...
                  <td align="center" bgcolor="#FFFFFF"><a href="index_teacher.php?assign&edit&course=<?php echo $course?>&id=<?php echo $row2['homeworkId']; ?>">แก้ไข</a></td>
