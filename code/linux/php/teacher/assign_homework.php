...
if( isset($_POST['Submit']) ){
	...
	if ($assigntype=='1') {
		$assigntype='1';
		$sql = "INSERT INTO homework_assignment (courseId,homeworkId,homeworkFileName,homeworkFileType,homeworkDetail,subFolder,dueDate,assignDate) 
	VALUES ('$course', '$hwId', '$filename', '$filetype', '$detail', '$lab', '$duedate', '$asdate') ";
	mysql_query($sql) or die(mysql_error());
	}elseif ($assigntype!='1') {

		    $assigntype='0';
		    $sql = "INSERT INTO homework_assignment (courseId,homeworkId,homeworkFileName,homeworkFileType,homeworkDetail,subFolder,dueDate,assignDate) 
	VALUES ('$course', '$hwId', '$lab', '$filetype', '$detail', '$lab', '$duedate', '$asdate') ";
	mysql_query($sql) or die(mysql_error());
		}
