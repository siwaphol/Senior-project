...
if( isset($_POST['Submit']) ){
	...
	$sql = "UPDATE homework_assignment SET courseId = '$course1', homeworkId = '$hwId1', homeworkFileName = '$filename', homeworkFileType = '$filetype', homeworkDetail = '$detail', subFolder = '$lab', dueDate = '$duedate', assignDate = '$asdate'
        ...
        <table id="myTable" width="400" border="1" align="center" cellpadding="0" cellspacing="0">
			...
			?>
				  ...
				  <tr>
				  	<td height="50" width="100" align="right" valign="middle" bgcolor="#FFFFFF">
					ชื่อไฟล์ &nbsp;</td>
					<td> <input type="text" name="fname" value="<?php echo $row['homeworkFileName']?>" /><font color="#FF0000">*</font>
					</td>
				  </tr>
				  <tr>
				  	<td height="50" width="100" align="right" valign="middle" bgcolor="#FFFFFF">
