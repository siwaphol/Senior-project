...
if( isset($_POST['Submit']) ){
	...
	$ta = $_POST['ddlTA'];
	//echo "couse=".$couse."   sec=" .$sec."  cnsme=".$cname;
	...
	if($check) {
		...
		echo "<script> window.location='index_teacher.php?editta' </script> ";
        ...
        <table id="myTable" width="500" border="1" align="center" cellpadding="0" cellspacing="0">
			<thead>
                  ...
                  <tr>
                    ...
                    <input type="hidden" id="c" name="c" value="<?php echo $course; ?>">
                    <input type="hidden" id="section" name="section" value="<?php echo $sec;?>">
					<br /><input type="text" name="cid"  id="cid" value="<?php echo $course?>" disabled="disabled" />
			...
			<tbody>  
                  <tr>
                    <td valign="top" align="right" bgcolor="#FFFFFF">&nbsp;
						...
						อาจารย์ : &nbsp;
						<?php
						$sql = "SELECT taId FROM assistant WHERE courseId ='$course' and sectionId = '$sec' ";
			  ...
			  <br /><input name="sec" value="<?php echo $sec?>" type="text" disabled="disabled" id="sec" class="sec" maxlength="3" />
