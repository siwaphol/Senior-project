...
<form action="" method="post" name="form1"  onsubmit="return onSubmitForm1('coursesec[]','กรุณาเลือกตอน')" >
              <table width="600" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#425969">
                ...
                <tr>
                  <td colspan="6" bgcolor="#BDE3F9">&nbsp;<a href="index_admin.php?editcourse&addsec">เพิ่มนักศึกษาช่วยสอน</a></td>
                </tr>
				<tr>
                ...
                <tr>
                  ...
                  <td align="center" bgcolor="#FFFFFF"><a href="index_teacher.php?editta&edit=<?php echo $course;?>&sec=<?php echo $sec;?> &ta=<?php echo $row['taid']; ?>">แก้ไข</a></td>
