...
?>
	<div style="border-left: 1px solid #e8e8e8; border-bottom: 1px solid #e8e8e8; background: #f5f5f5">
        ...
        <?php if($this->data['errorcode']==="USERFORGOTPASSWORD"){
            $repasswordlink=htmlspecialchars($this->data['errorparams']['%URL%']);
            $this->data['errorparams']['%URL%'] = " "?>
		<p><?php echo htmlspecialchars($this->t('{errors:descr_' . $this->data['errorcode'] . '}', $this->data['errorparams']));
            if($this->language==="th"){?>
                <a href="<?php echo $repasswordlink;?>">ที่นี่</a></p>
            <?php }else{?>
                <a href="<?php echo $repasswordlink;?>">here</a>.</p>
        <?php }}else{ ?>
