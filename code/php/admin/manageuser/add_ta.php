...
<?php		
//-------ทำการ insert ค่าเพิ่มข้อมูลนักศึกษาช่วยสอนลง database 
...
<br />
<center>
  <span class="style1">เพิ่มข้อมูลนักศึกษาช่วยสอน</span>
</center>
<br />
        <table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                   <td height="31" colspan="3" align="center" bgcolor="#425969"><span class="style2">แบบฟอร์มเพิ่มข้อมูลนักศึกษาช่วยสอน</span></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="69" colspan="3" bgcolor="#FFFFFF" align="center">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="button" name="cancel" onclick="window.location='index_admin.php?ta-data'" value="ยกเลิก" />                    </td>
                  </tr>
              </table>
            </form>
<?php } ?>
