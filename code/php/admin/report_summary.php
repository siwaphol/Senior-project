...
<br />
<center>
  <span class="style1">รายงานสรุปคะแนน</span>
<br />
<br />
</center>
...
<br />
 <center>
 <span class="style1">ผลสรุปคะแนนของนักศึกษา<br />
 วิชา : &nbsp;<?php echo $course2?> &nbsp;&nbsp; ตอน : &nbsp;<?php echo $sec2?> <br /><br />
 </span>
 </center>
 
 <img src="../images/excel.gif" /><a href="exportReport/export_summary.php?course=<?php echo $course2?>&sec=<?php echo $sec2?>&year=<?php echo $year?>&sem=<?php echo $sem?>">ดาวน์โหลดรายงานผลสรุปคะแนนของนักศึกษา</a>
                  ...
                  <td bgcolor="#FFFFFF">&nbsp;<?php echo $row1['studentName'] ?></td>
					  ...
					  $result2 = mysql_query($command2);
					  	while($rows = mysql_fetch_array($result2)) {
							$command3 = "select score from homework_sending where studentId ='$student' and courseId='$course2' AND homeworkId = '$rows[homeworkId]' ";
							$result3 = mysql_query($command3);
							$row3 = mysql_fetch_array($result3);
							if(mysql_num_rows($result3) == 0 || $row3['score'] == 0)
								$score = 0;
							else
								$score = $row3['score'];
					  ?>
					  <td width="30" align="center" bgcolor="#FFFFFF"><?php echo $score?></td>
					  <?php } } ?>
                </tr>
