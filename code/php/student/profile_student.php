...
{	
	$stuid = $_SESSION['user']; // รหัสนักศึกษาก่อนที่จะแก้ไข
	$stuname = $_POST['name']; 
	$pwd = $_POST['pwd'];
	$email = $_POST['email'];
	$phone = $_POST['phone'];
	
	$command2 = "UPDATE student SET studentName = '$stuname' , studentPw = '$pwd', email = '$email', phone = '$phone' 
	WHERE  studentId = '$stuid' ";
	mysql_query($command2) or die (mysql_error()); 
	if(mysql_affected_rows() != 0) { ?>
		<div id="checkErr">อัพเดทข้อมูลเรียบร้อยแล้ว</div>
	<?php }else { ?>
...
<br />
<center>
  <span class="style1">ข้อมูลส่วนตัวนักศึกษา</span>
</center>
<br />
		<table width="500" border="1" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			...
			<input name="code" type="text" id="code" onKeyPress="fixkey()" value="<?php echo $row['studentId']; ?>" maxlength="9" disabled="disabled"  /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			<td height="69" colspan="3" bgcolor="#FFFFFF" align="center">
			  ...
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="button" name="cancel" onclick="window.location='index_student.php'" value="ยกเลิก" />                    
			</td>
		  </tr>
		</table>
	  </form>
