...
{
    // default connection
    public static $dbname = 'authenmodule'; // Your database name
    public static $dbuser = 'admin'; // Your database username
    public static $dbpass = 'R71lMJUU'; // // Your database password
    ...
    // xcrud folder url
    public static $scripts_url = '/myshop/xcrud/xcrud'; // URL to the xCRUD folder, not real path, without a trailing slash, can be relative, e.g. 'some_folder/xcrud' or absolute, e.g. 'http://www.your_site.com/some_folder/xcrud'. If empty - will be detected automatically
